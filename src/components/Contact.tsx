...
const links = [
  { icon: Mail, href: 'mailto:rajgadhwal99@gmail.com', label: 'rajgadhwal99@gmail.com', external: false },
  { icon: Github, href: 'https://github.com/Rjaat', label: 'github.com/Rjaat', external: true },
  { icon: Linkedin, href: 'https://linkedin.com/in/rajesh-choudharyy', label: 'linkedin.com/in/rajesh-choudharyy', external: true },
  { icon: MapPin, href: '#', label: 'New Delhi, India', external: false },
  { icon: FileText, href: '/Rajesh_Jat_Resume.pdf', label: 'Resume (PDF)', external: false },
]
